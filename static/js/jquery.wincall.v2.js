...
WinCall.prototype.allButtonActions = ['login', 'logout', 'dialinner', 'dialouter', 'hangup', 'answer', 'consultinner', 'consultouter', 'consultback', 'busy', 'unbusy', 'hold', 'restore', 'transfer', 'threeway', 'threewayback', 'chanspy', 'intercept', 'breakin', 'evaluate', 'enable_autocall', 'disable_autocall', 'transivr', 'transque', 'blindtrans'];
/** 消息返回编码 */
...
WinCall.prototype.msgResponce = function (obj_responce) {
    var self = this;
    var returnObject = {code:'',msg:'',type:'',agStatus:'',queStatus:'',enableActions:[],disableActions:[]};
        ...
        case self.returnType.RETURN_PHONE://电话状态消息返回 如呼叫中,振铃,挂机
            switch(obj_responce.PhoSta) {
                ...
                case self.phone_states.PHRN_CONNECT://接通
                    ...
                    returnObject.enableActions = ['hangup', 'evaluate', 'consultinner', 'consultouter', 'hold', 'transque', 'transivr', 'blindtrans', 'intercept', 'breakin'];
                ...
                case self.phone_states.PHRN_HANGUP ://通话完成
                    ...
                    returnObject.disableActions = ['consultinner', 'consultouter', 'hangup', 'evaluate', 'transfer', 'hold', 'restore', 'consultback', 'threeway', 'threewayback', 'transque', 'transivr', 'blindtrans', 'intercept', 'breakin'];
